...
from users.serializers import (SignUpSerializer, ChangeUserInformationSerializer, LoginSerializer,
                                LoginRefreshSerializer, LogoutSerializer, ForgotPassswordSerializer,
                                ResetPasswordSerializer, VerifyCodeSerializer, ProfileSerializer)  
from users.models import CODE_VERIFIED, NEW, VIA_EMAIL, VIA_PHONE, User, Profile
from rest_framework.views import APIView
from django.utils.datetime_safe import datetime
from rest_framework.exceptions import ValidationError, NotFound
from rest_framework.response import Response
from config.utility import send_email, check_email_username_or_phone
